...
async function main() {
  ...
  await sql`
    ...
    VALUES ('intro', ${INTRO}), ('about', ${ABOUT}), ('hero_name', 'Sunday'), ('hero_tagline', 'a reading log, in deep purple')
