...
export const metadata = { title: "Draft · About (Lavender)" };

export default async function LavenderAboutPage() {
  const data = await getAboutData();
  return (
    <div className={`${archivo.variable} ${grotesk.variable} ${hand.variable}`}>
      <AboutScrap theme="lav" text={data.about} contributors={data.contributors} />
      <DraftBar />
    </div>
  );
}
