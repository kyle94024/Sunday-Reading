...
export const metadata = { title: "Draft · About (Strawberry)" };

export default async function StrawberryAboutPage() {
  const data = await getAboutData();
  return (
    <div className={`${archivo.variable} ${grotesk.variable} ${hand.variable}`}>
      <AboutScrap theme="berry" text={data.about} contributors={data.contributors} />
      <DraftBar />
    </div>
  );
}
