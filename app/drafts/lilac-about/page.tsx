...
export const metadata = { title: "Draft · About (Lilac)" };

export default async function LilacAboutPage() {
  const data = await getAboutData();
  return (
    <div className={`${archivo.variable} ${grotesk.variable} ${hand.variable}`}>
      <AboutScrap theme="lilac" text={data.about} contributors={data.contributors} />
      <DraftBar />
    </div>
  );
}
